            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-ok"></i> Inserimento cliente</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form id="mws-validate" class="mws-form" action="add_clienti_process.php" method="post" enctype="multipart/form-data">
                        	...
                        	<div class="mws-form-inline">
								...
								<div class="mws-form-cols clearfix">
									...
									<div class="mws-form-col-2-8 omega">
                                        ...
                                        while ($i < $num) {
                                        $id = mysqli_result($risultati,$i,"id_province");
                                        $nome = mysqli_result($risultati,$i,"nome_province");
                                        ?>
                            ...
                            <div class="mws-button-row">
                            	<input type="submit" class="btn btn-danger" value="Inserisci Cliente"/>
                            </div>
						</div>
