...
var r=confirm("Vuoi davvero eliminare il concessionario?");
	if (r==true){
	  window.location.assign("del_concessionario.php?id="+id);
	}
}
</script>
</head>
...
<?php
$query="SELECT * FROM concessionari, province WHERE tipo = 0 AND concessionari.id_provincia = province.id_province AND id_status >= 1 ORDER By id_concessionaria desc";
$risultati=mysql_query($query);
$num=mysql_numrows($risultati);
?>             
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> Elenco concessionari</span>
                    </div>
...
$i=0;
while ($i < $num) {
$id=mysql_result($risultati,$i,"id_concessionaria");
...
$citta=mysql_result($risultati,$i,"citta");
...
?>
                                <tr>
									...
									<div class="btn-group">
										...
										<a href="edit_concessionari.php?id=<?php echo $id;?>" class="btn btn-small"><i class="icol-pencil"></i> Modifica</a>										
