...
if( isset($_GET['id']) ){
	...
	$query = @mysql_query("SELECT * FROM auto WHERE id = {$id_auto}");
                        	...
                        	<div class="mws-form-inline">
								...
								<div class="mws-form-cols clearfix">
                                	<div class="mws-form-col-2-8 alpha omega">
										...
										while($crow = mysql_fetch_array($res_select)) { ?>
									...
									<div class="mws-form-col-2-8 omega">
										...
										<div class="mws-form-item large">
											<select class="required" name="alimentazione">
												<option></option>
												<?php
												$res=mysql_query("SELECT * FROM alimentazione ORDER BY nome_alimentazione");
								...
								<div class="mws-form-row">
	                            	...
	                            	<div class='mws-form-cols'>
										...
										if( isset($id_auto) ){
											...
											$acc_auto = @mysql_query($query);
											while($row = mysql_fetch_array($acc_auto)) {
										...
										while($row = mysql_fetch_array($risultati)) {
											...
											$risultati_accessori=mysql_query($query_accessori_selezionati);
											$row_accessori = mysql_fetch_array($risultati_accessori);
