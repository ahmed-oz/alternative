				...
				*/
				if(isset($_POST['form_name_hidden']) && $_POST['form_name_hidden'] == 1) {
					...
					if(isset($_POST['targa_telaio']))
					{
						...
						if(!empty($_POST['targa_telaio'])) $where .= " AND (auto.targa LIKE '%" . mysql_real_escape_string($_POST['targa_telaio']) . "%'" .
																	 " OR auto.telaio LIKE '%" . mysql_real_escape_string($_POST['targa_telaio']) . "%')";
					}
					...
					<form id="frm_filters" method="post" action="">
						<div id="table_advanced_search" >
							...
							<div class="dataTables_searchForm" >
								...
								<?php $result = mysql_query("SELECT * FROM alimentazione"); ?>
						...
						<table class="mws-datatable-fn mws-table" id="table_auto">
							...
							while ($i < $num) {
								...
								$immatricolazione=mysql_result($risultati,$i,"immatricolazione");
								...
								$ubicazione=mysql_result($risultati,$i,"ubicazione");
								$nome_alimentazione=mysql_result($risultati,$i,"nome_alimentazione");
								...
								$cilindrata=mysql_result($risultati,$i,"cc");
								$cavalli=mysql_result($risultati,$i,"cv"); 
