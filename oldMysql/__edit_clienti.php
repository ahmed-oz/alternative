...
<body>
	...
	$id_concessionaria = mysql_real_escape_string($_GET['id']);

	$query = @mysql_query("SELECT * FROM concessionari, province WHERE concessionari.id_provincia = province.id_province AND concessionari.id_concessionaria = $id_concessionaria");
    $quanti = mysql_num_rows($query);
    if ($quanti == 0)
    {
        $error = "<div class='mws-form-message error'>Attenzione!<ul><li>Nessun cliente con questo valore.</li></ul></div>";
    }
    else {
...
?>                              
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-ok"></i> Modifica cliente</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form id="mws-validate" class="mws-form" action="edit_clienti_process.php" method="post" enctype="multipart/form-data">
                        	...
                        	<div class="mws-form-inline">           
								<div class="mws-form-cols clearfix">
                                	<div class="mws-form-col-4-8 alpha">
										<label class="mws-form-label">Nome e Cognome</label>
...
while ($i < $num) {
$id_province=mysql_result($risultati,$i,"id_province");
$nome_province=mysql_result($risultati,$i,"nome_province");
?>
...
?>
                            ...
                            <div class="mws-button-row">
                            	<input type="submit" class="btn btn-danger" value="Modifica Cliente"/>
                            </div>
						</div>
