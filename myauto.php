    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
                ...
                $query="SELECT * FROM auto  WHERE  id_concessionario = '$id_utente_sessione' AND auto.id_status > 0 ORDER By id desc";
                    ...
                    <div class="mws-panel-body no-padding">
                        <table id="table_auto" class="mws-datatable-fn mws-table">
							...
							while ($i < $num) {
								...
								$id_status=mysqli_result($risultati,$i,"id_status");
								switch ($id_status) {
									case "1":
								...
								$data_inserimento = mysqli_result($risultati,$i,"data_inserimento");
