...
img.thumb { width:100%; margin: 0 auto; }
	...
	if(isset($_GET['id']) && $_GET['id']) {
		...
		if ($_SESSION['id_livello_sessione'] >= 3) {
			$query = mysqli_query($conn,"SELECT auto.*, concessionari.nome_concessionaria , auto.id_status as autoidstatus 
					...
					<td style="width:50%;" valign="top">
						<table class="table-box">
							...
							<tr>
								...
								<?php $res = mysqli_query($conn,"SELECT nome_alimentazione FROM alimentazione WHERE id='$alimentazione';"); ?>
								<td class="table-box-row <?php echo printEvenOrOdd($n); ?>"><?php echo (mysqli_result($res,0,0))?:'---'; ?></td>
							</tr><?php $n++; ?>
							<tr>
